...
function UserDashboard() {
  ...
  const { loading, getAllOrder } = contex;
    ...
    <Layout>
      <div className="container mx-auto px-4 py-5 lg:py-8">
        ...
        <div className="bottom">
          <div className="mx-auto my-4 max-w-7xl px-2 md:mx-0 md:py-6">
                            ...
                            <div className="p-8">
                              <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-1">
                                ...
                                <div className="mb-4">
                                  ...
                                  <div className="text-sm font-medium text-gray-900 first-letter:capitalize">
                                    {status}
                                  </div>
                                </div>
                              </div>
